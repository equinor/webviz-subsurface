...
from ._business_logic import
from ._layout import LayoutElements


def plugin_callbacks(app: Dash, get_uuid: Callable, data_model: WellCompletionsDataModel)
    @app.callback(
    ...
    def _render_well_completions(ensemble_name: str) -> list:
        data = wellcompletions_datamodel.create_ensemble_dataset(ensemble_name)
