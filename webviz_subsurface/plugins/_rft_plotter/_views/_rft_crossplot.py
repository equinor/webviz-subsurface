        ...
        @callback(
            ...
            Input(
                self.get_settings_element_id(
                    FilterLayout.Ids.FILTER_WELLS[self.tab], self.Ids.CROSSPLOT_FILTERS
                ),
                "value",
            ),
            Input(
                self.get_settings_element_id(
                    FilterLayout.Ids.FILTER_ZONES[self.tab], self.Ids.CROSSPLOT_FILTERS
                ),
                "value",
            ),
            Input(
                self.get_settings_element_id(
                    FilterLayout.Ids.FILTER_DATES[self.tab], self.Ids.CROSSPLOT_FILTERS
                ),
                "value",
            ),
            Input(
