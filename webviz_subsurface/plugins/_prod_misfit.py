...
class ProdMisfit(WebvizPluginABC):
    ...
    * Visualization of prod coverage at selected time.
    ...
    def __init__(
        ...
        if csvfile_prod and ensembles:
            raise ValueError(
                'Incorrent arguments. Either provide a "csvfile_prod" or "ensembles"'
            )

        if csvfile_prod:
            df_smry = pd.read_csv(csvfile_prod)
            self.ensembles = sorted(list(df_smry.ENSEMBLE.unique()))
        elif ensembles:
            ...
            # -----------------------------------------
            df_smry = emodel.get_or_load_smry_cached()
            # df_smry.to_csv("~/webviz/smry.csv")
        else:
            raise ValueError(
                'Missing arguments. Either provide a "csvfile_prod" or "ensembles"'
            )
    ...
    def _misfit_per_real_layout(self) -> list:
        children = [
            wcc.FlexBox(
                id=self.uuid("prod_misfit-layout"),
                children=[
                    wcc.Frame(
                        style={
                            "flex": 1,
                        ...
                        children=[
                            wcc.Selectors(
                                ...
                                children=[
                                    wcc.Dropdown(
                                        ...
                                        id=self.uuid("prod_misfit-ensemble_names"),
                                        options=[
                                            {"label": ens, "value": ens}
                            ...
                            wcc.Selectors(
                                ...
                                children=[
                                    wcc.SelectWithLabel(
                                        label="Date selector",
                                        id=self.uuid("prod_misfit-dates"),
                                        options=[
                                    ...
                                    wcc.SelectWithLabel(
                                        ...
                                        id=self.uuid("prod_misfit-phases"),
                                        options=[
                                    ...
                                    wcc.SelectWithLabel(
                                        label="Well selector",
                                        id=self.uuid("prod_misfit-well_names"),
                                        options=[
                                    ...
                                    wcc.SelectWithLabel(
                                        ...
                                        id=self.uuid("prod_misfit-realizations"),
                                        options=[
                            ...
                            wcc.Selectors(
                                ...
                                children=[
                                    wcc.Dropdown(
                                        label="Colorby",
                                        id=self.uuid("prod_misfit-colorby"),
                                        options=[
                                            {
                                                "label": "Total misfit",
                                                "value": "misfit",
                                    ...
                                    wcc.Dropdown(
                                        ...
                                        id=self.uuid("prod_misfit-sorting"),
                                        options=[
                                            {
                                                "label": "None",
                                                "value": None,
                                    ...
                                    wcc.Dropdown(
                                        ...
                                        id=self.uuid("prod_misfit-figheight"),
                                        options=[
                                            {
                                                "label": "Very small",
                                                "value": 250,
                    ...
                    wcc.Frame(
                        ...
                        children=[html.Div(id=self.uuid("prod_misfit-graph"))],
                    ),
                ],
            ),
        ]
    ...
    def _well_prod_coverage(self) -> list:
        children = [
            wcc.FlexBox(
    ...
    def _group_prod_coverage(self) -> list:
        children = [
            wcc.FlexBox(
        ...
        return wcc.Tabs(
            ...
            children=[
                ...
                wcc.Tab(
                    ...
                    style=tab_style,
                    selected_style=tab_selected_style,
                    children=self._well_prod_coverage(),
                ),
                wcc.Tab(
                    label="Group production coverage",
                    style=tab_style,
                    selected_style=tab_selected_style,
                    children=self._group_prod_coverage(),
                ),
                wcc.Tab(
                    label="Well production heatmap",
                    style=tab_style,
                    selected_style=tab_selected_style,
                    children=self._heatmap(),
                ),
            ],
        )
