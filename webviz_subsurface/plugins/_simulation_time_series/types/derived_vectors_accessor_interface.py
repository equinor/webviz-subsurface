...
# "Accessor"
# Suggestions:
# - DerivedEnsembleDataAccessorInterface
# - DerivedEnsembleDataInterface
# - DerivedEnsembleVectorsInterface
# - DerivedEnsembleVectorsProviderABC
# - DerivedVectorsProviderInterface
# - DerivedVectorsAccessorInterface
class DerivedVectorsAccessorInterface:
    @abc.abstractmethod
