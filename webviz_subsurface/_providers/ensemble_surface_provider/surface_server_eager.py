...
ROOT_URL_PATH = "/SurfaceServerEager"
...
class SurfaceServerEager:
    def __init__(self, app: Dash) -> None:
        cache_dir = (
            ...
            / f"SurfaceServerEager_filecache_{uuid4()}"
        )
    ...
    @staticmethod
    def instance(app: Dash) -> "SurfaceServerEager":
        global SURFACE_SERVER_INSTANCE
        if not SURFACE_SERVER_INSTANCE:
            LOGGER.debug("Initializing SurfaceServerEager instance")
            SURFACE_SERVER_INSTANCE = SurfaceServerEager(app)
