...
from ._provider_impl_fmu_standard import ProviderImplFMUStandard
from ._grid_fmu_standard_discovery import discover_per_realization_grid_files
...
class EnsembleGridProviderFactory(WebvizFactory):
    ...
    def create_from_fmu_standard_grid_files(
        ...
        provider = ProviderImplFMUStandard.from_backing_store(
        ...
        timer.lap_s()
        grid_files, grid_parameter_files = discover_per_realization_grid_files(
        ...
        ProviderImplFMUStandard.write_backing_store(
            self._storage_dir,
            storage_key,
            grids=grid_files,
            grid_parameters=grid_parameter_files,
